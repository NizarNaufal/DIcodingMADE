...
data class SearchUser(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<SearchUser> = object : Parcelable.Creator<SearchUser> {
            override fun createFromParcel(source: Parcel): SearchUser = SearchUser(source)
            override fun newArray(size: Int): Array<SearchUser?> = arrayOfNulls(size)
        }
    }
}